          ...
          case 4:
            if (command === "add-or-toggle-reading-list") {
              ...
              chrome.tabs.query({
                ...
                var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tabs) {
                  var _tabs$, url, title, items;
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          console.log("Tab title: ".concat(tabs[0].title, " and url: ").concat(tabs[0].url));
                          _tabs$ = tabs[0], url = _tabs$.url, title = _tabs$.title;
                          _context.next = 5;
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("a42d53d8f9b58232c3c1")
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "Read Later +:";
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdateRead_Later_"] = (chunkId, moreModules, runtime) => {
